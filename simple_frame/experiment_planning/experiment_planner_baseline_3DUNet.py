...
from simple_frame.configuration import default_num_threads
from simple_frame.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from simple_frame.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from simple_frame.experiment_planning.utils import create_lists_from_splitted_dataset
from simple_frame.network_architecture.generic_UNet import Generic_UNet
from simple_frame.paths import *
from simple_frame.preprocessing.cropping import get_case_identifier_from_npz
from simple_frame.training.model_restore import recursive_find_python_class
...
class ExperimentPlanner(object):
    ...
    def run_preprocessing(self, num_threads):
        ...
        preprocessor_class = recursive_find_python_class([simple_frame.__path__[0]+"/"+ "preprocessing"],
                                                         self.preprocessor_name, current_module="simple_frame.preprocessing")
