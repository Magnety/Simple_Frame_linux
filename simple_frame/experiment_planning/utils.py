...
from simple_frame.experiment_planning.common_utils import split_4d_nifti
from simple_frame.paths import raw_data, cropped_data, preprocessing_output_dir
from simple_frame.preprocessing.cropping import ImageCropper
...
def plan_and_preprocess(task_string, processes_lowres=default_num_threads, processes_fullres=3, no_preprocessing=False):
    #from simple_frame.experiment_planning.experiment_planner_baseline_2DUNet import ExperimentPlanner2D
    from simple_frame.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
