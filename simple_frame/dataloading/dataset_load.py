...
class DataLoader3D(SlimDataLoaderBase):
    def __init__(self, data, patch_size, final_patch_size, batch_size, has_prev_stage=False,
                 ...
                 pad_sides=None,fc_path='G:/simple_frame_data_raw_base/simple_frame_raw_data/Task100_Breast_c_f_noclsmask'):
        """
    ...
    def generate_train_batch(self):
        ...
        feature = []
        case_properties = []
        #class_name = pd.read_excel('/home/ubuntu/zhangyongtao/Simple_Frame/class_label.xlsx',dtype=object, keep_default_na=False, na_values=[]).values
        #print("////////////////////selected_keys//////////////////")
        #print(selected_keys)
